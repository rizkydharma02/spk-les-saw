                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-content">
                                <div class="card-body">
                                    <p class="card-text">Pengambil keputusan memberi bobot preferensi dari setiap
                                        kriteria dengan
...
while ($row = $result->fetch_object()) {
    echo "<tr>
        ...
        <td>{$row->attribute}</td>
        <td>
            <a href='bobot-edit.php?id={$row->id_criteria}' class='btn btn-primary btn-sm'>Edit</a>
            </td>
      </tr>\n";
}
$result->free();
